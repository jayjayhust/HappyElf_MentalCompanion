...
file_train_converted_path = './datasets/mental_health/PsyQA_full_train_converted.json'  # 

def dataset_join_and_convert(file_1_path, file_2_path, file_converted_path):
    ...
    with open(file_2_path, "r", encoding='utf-8') as f:
        content = f.read()
        data_json.extend(json.loads(content))
...
if __name__ == '__main__':
    dataset_join_and_convert(file_train_1_path, file_train_2_path, file_train_converted_path)