...
file_test_path = './datasets/mental_health/PsyQA_full_test.json'  # 调试数据集路径（1150条数据）
file_test_converted_path = './datasets/mental_health/PsyQA_full_test_converted.json'  # 
...
if __name__ == '__main__':
    dataset_convert(file_test_path, file_test_converted_path)
