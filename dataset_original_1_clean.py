...
file_path = './datasets/mental_health/original/full_PsyQA/PsyQA_generation_split/large_span_enstra_PsyQA_train_1.json'  # 原始数据集
file_after_clean_path = './datasets/mental_health/large_span_enstra_PsyQA_train_1_cleaned.json'  # 输出的json文件数据集路径
file_after_clean_txt_path = './datasets/mental_health/large_span_enstra_PsyQA_train_1_cleaned.txt'  # 输出的txt文件数据集路径
