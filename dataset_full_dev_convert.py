...
file_dev_path = './datasets/mental_health/PsyQA_full_dev.json'  # 调试数据集路径（1150条数据）
file_dev_converted_path = './datasets/mental_health/PsyQA_full_dev_converted.json'  # 
...
if __name__ == '__main__':
    dataset_convert(file_dev_path, file_dev_converted_path)
